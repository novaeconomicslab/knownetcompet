...
from sources.graph_mappers.companies_mapper import companies_mapper
...
from sources.companies_dm import CompaniesDMSource
from sources.companies_pt_ids import CompaniesPTIDsSource
from sources.companies_sh import CompaniesSHSource
...
#     (CompaniesDMSource, 'companies_dm.csv', None),
#     (CompaniesSHSource, 'companies_sh.csv', None),
#     (CompaniesPTIDsSource, 'companies_pt_ids.csv', None),
...
GRAPH_LOADER_CONFIG = [
    ...
    # ("companies_gold", companies_mapper),
    # ("pep_gold", pep_mapper),
]
