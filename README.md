# KNOW-NET-COMPET 🔍
Embedded Knowledge and Networks: Complexity in Antitrust Collusion Mitigation (DOI:10.54499/2024.07378.IACDC)
...
1. **Data Sources** — Portal BASE, Anuário OCC, and other registries
...
| **Companies Web Scrapping** | Corporate ownership and director/shareholder data | Company relationships |
...
│   ├── companies_*.py               # Companies data processors
│   │
