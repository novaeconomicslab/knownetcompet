# sources/graph_mappers/companies_mapper.py
"""
Companies mapper using declarative configuration.

Maps raw Companies documents (person-company relationships) from companies_gold to 
...
def companies_mapper(raw_doc: dict) -> dict:
    """
    Takes a raw Companies document (person + company relationships)
