...
class CompaniesPTIDsSource(BaseDataSource):
    source_name = "companies_pt_ids"
    ...
    def transform(self, data):
        ...
        try:
            dm_docs = self.db_connector.get_all_documents("companies_dm_silver")
            sh_docs = self.db_connector.get_all_documents("companies_sh_silver")
